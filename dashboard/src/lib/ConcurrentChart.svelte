...
<HistoryChart {history} {peak} legend={history.sample_interval_seconds > 60 ? '평균 접속 계정 수' : '접속 계정 수'} legendLabel="합계" valueLabel={history.sample_interval_seconds > 60 ? '계정 합계 (평균)' : '계정 합계'}>
