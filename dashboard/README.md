...
아래의 유니크 접속 계정 그래프는 매일 한국 시간 자정 기준으로 집계해 DB에 저장한 값을 표시합니다. 1일·1주일·1개월·6개월·1년의 계정을 각각 중복 제거하며, 화면 조회 시 접속 이력을 다시 계산하지 않습니다. 두 그래프는 기간을 따로 선택하고 마우스를 올려 상세 내용을 확인합니다. 유니크 계정은 마지막 집계 기준 시각과 이력 부족 안내를 표시하며, 첫 집계는 수집 시작 후 다음 자정에 생성됩니다. 화면은 30초마다 저장된 결과를 다시 읽습니다.
