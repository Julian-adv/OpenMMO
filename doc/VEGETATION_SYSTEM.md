...
- **텍스처**: `/textures/flower.png` alpha map. 색상 variation은 instance hash 기반 palette 선택 — 노란색(민들레), 분홍(코스모스), 흰색(데이지) 3색
- **Material**: `FLOWER_CONFIG` — baseColor 진녹, windStrength 0.04 (뻣뻣한 줄기), scale 0.42~0.60, heightScaleExtent 0.5
