...
- 프로토콜 **98**: `PlayerMoveGoal(request_id, x, z, sprinting, stop_at_entrance)`,
...
- 클라: 전체 테스트 1,298개 통과. 200/500/1,000ms 프레임 정지, 응답 단절, 늦은 응답,
...
- 서버 release 전체 테스트 991개 통과(7개 기본 제외, 그중 이동 부하 시험은 별도 실행),
  agent-client 293개·공유 Rust 424개 및 보조 테스트 2개 통과.
