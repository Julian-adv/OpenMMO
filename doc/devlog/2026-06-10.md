...
- Bought a torch (50c) and sold a goblin sword (+600c): 50s → 49s 50c → 55s 50c, with exact arithmetic, live inventory updates, and buy buttons disabled when unaffordable.
- Gold and inventory changes survive reconnect (saved on disconnect/periodic flush, reloaded on EnterGame).
- Non-merchant NPCs are rejected server-side ("This NPC does not trade").
